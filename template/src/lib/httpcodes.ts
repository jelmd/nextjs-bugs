...
export class HTTP {
	...
	public static RESERVED = 306;
	public static TEMPORARY_REDIRECT = 307;
	public static PERMANENTLY_REDIRECT = 308;
	...
	public static VERSION_NOT_SUPPORTED = 505;
	public static VARIANT_ALSO_NEGOTIATES_EXPERIMENTAL = 506;
